...
public class GokstadAthleticsExceptionHandling
{
    private readonly RequestDelegate _next;
    private readonly ILogger<GokstadAthleticsExceptionHandling> _logger;

    public GokstadAthleticsExceptionHandling(RequestDelegate next, 
        ILogger<GokstadAthleticsExceptionHandling> logger)
    {
        _next = next;
        _logger = logger;
    }
